...
export class Ken extends Fighter {
            ...
            frames = new Map([//角色貼圖
                ...
                ['jump-roll-3', [[[1364, 994, 104, 42],[61, 76]], PushBox.JUMP, [[22, -51, 24, 16], [-14, -81, 40, 42], [-22, -66, 38, 18]]]],
                ...
                // Stand Turn
                ['idle-turn-1', [[[428, 682, 54, 95],[29 ,92]], PushBox.IDLE, [[-10, -89, 28, 18], [-14, -74, 40, 42], [-14, -31, 40, 32]]]],
            ...
            initialVelocity = {
                x: {
                    ...
                    [FighterState.JUMP_BACKWARD]: -((48 * 4 ) + (15 * 3) ),
                },
                jump: -420,
            }
            gravity = 1000;
